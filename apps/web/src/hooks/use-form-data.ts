    ...
    switch (step) {
      ...
      case 2: // sustainability step
        return {
          ...formData,
          // Static defaults
          hasPracticesPolicies: formData.hasPracticesPolicies !== undefined ? formData.hasPracticesPolicies : false,
          
          // API data (if available)
          ...(sustainabilityData && {
            sustainabilityCertifications: formData.sustainabilityCertifications || sustainabilityData.certifications,
            practicesDescription: formData.practicesDescription || sustainabilityData.practicesTemplate,
            hasPracticesPolicies: formData.hasPracticesPolicies !== undefined ? formData.hasPracticesPolicies : sustainabilityData.hasPreviousPractices,
          }),
        };
