...
describe('ProgressBar', () => {
  ...
  it('should apply custom className', () => {
    const { container } = render(
      <ProgressBar currentStep={0} totalSteps={3} className="custom-class" />
    )
...
describe('StepIndicator', () => {
  it('should render all steps', () => {
    render(<StepIndicator steps={stepConfigurations as any} currentStep={1} />)
  ...
  it('should show completed steps with check icon', () => {
    render(<StepIndicator steps={stepConfigurations as any} currentStep={2} />)
  ...
  it('should highlight current step', () => {
    ...
    const stepCircles = screen.getAllByRole('generic').filter(el => 
      el.className.includes('rounded-full')
    )
    
    // Current step should have ring styling
    const currentStepCircle = stepCircles.find(el => 
  ...
  it('should show step numbers for future steps', () => {
    render(<StepIndicator steps={stepConfigurations as any} currentStep={0} />)
  ...
  it('should apply custom className', () => {
    const { container } = render(
      <StepIndicator 
        steps={stepConfigurations as any} 
        currentStep={0} 
...
describe('FormNavigation', () => {
  ...
  it('should apply custom className', () => {
    const { container } = render(
      <FormNavigation {...defaultProps} className="custom-class" />
    )
